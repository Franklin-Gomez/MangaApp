                ...
                { 
                    capitulos.map( ( cap ) => (
                        <div key={cap.id} className=" flex justify-between items-center p-4   bg-white/30 rounded transition-colors cursor-pointer">
                            ...
                            <div>
                                <h3 className=" text-dialogue font-semibold"><span>Capitulo  - </span>{cap.number}</h3>
                                <p className=" text-sm text-gray-300">Publicado el: 2024-01-01</p>
                            </div>

                            <div>
                                <a href={`/viewer/${cap.id}`} className=" bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded">Leer</a>   
                            </div>
